import { Platform, SafeAreaView, StyleSheet, Text, View, Image, TextInput, FlatList, Dimensions, TouchableOpacity } from 'react-native'
...
const AllDoctor = ({navigation}) => {
    ...
    return (
        <SafeAreaView style={{ flex: 1, backgroundColor: '#F0F3F5' }}>
            ...
            <Text style={{ color: '#174666', fontSize: 18, fontWeight: '800',marginLeft:30 }}>All Doctors</Text>
                    </View>
                    <View style={{ flexDirection: 'row', paddingHorizontal: 15, backgroundColor: 'white', height: 50, borderRadius: 13, alignItems: 'center', marginVertical: 12 }}>
                        ...
                        <Image style={{ width: 30, height: 30, marginLeft: 10,borderRadius:7 }} source={require('/Users/mac/Documents/React-Native/myProject/client/assets/images/filter.png')}></Image>
                    </View>
